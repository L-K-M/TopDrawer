...
- **Eight tab types** — an **items** tab (apps, files, folders, links arranged freely
  in a grid with gaps), a **notes** tab (a live Markdown scratchpad: type formatted text, tick off task
  items, switch to raw Markdown when you want it), a **folder** tab
