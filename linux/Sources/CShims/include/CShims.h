...
/* The birth (creation) time of the file at `path`, as Unix epoch seconds, or -1 when
 * the platform or filesystem doesn't provide it (then fall back to mtime — see
 * FreshScanner's ladder).
 *
